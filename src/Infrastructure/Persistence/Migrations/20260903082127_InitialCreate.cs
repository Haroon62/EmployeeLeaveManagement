        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_LeaveTypes_DefaultAnnualDays", "[DefaultAnnualDays] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_LeaveBalances_AllocatedDays", "[AllocatedDays] >= 0");
                    table.CheckConstraint("CK_LeaveBalances_RemainingDays", "[RemainingDays] >= 0");
                    table.CheckConstraint("CK_LeaveBalances_TotalDays", "[AllocatedDays] = [UsedDays] + [RemainingDays]");
                    table.CheckConstraint("CK_LeaveBalances_UsedDays", "[UsedDays] >= 0");
                    table.CheckConstraint("CK_LeaveBalances_Year", "[Year] >= 2000 AND [Year] <= 2100");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_LeaveRequests_RejectionReason", "[Status] <> 'Rejected' OR LEN(LTRIM(RTRIM([RejectionReason]))) > 0");
                    table.CheckConstraint("CK_LeaveRequests_WorkingDays", "[WorkingDays] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IdempotencyRecords_LeaveRequests_LeaveRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdempotencyRecords_LeaveRequestId",
